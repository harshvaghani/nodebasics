...
const sportsSchema = new mongoose.Schema({
    ...
    //custom validate is used when a user enters non value in an array but still mongo will consider it a true value 
    tags: {
        type: Array,
        validate: {
            validator: function(v) {
                return v && v.length > 0; //this property will be valid only if v.lenght >0 //we have used v here because we don't want to value of this to be null
            },
